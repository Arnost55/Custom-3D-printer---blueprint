...
### 🛠️ Build Process: Custom Steel 3D Printer

**1. Design & Planning**

- Modeled the entire 3D printer digitally to map out the frame and component placement.
- Planned the layout for the stepper motors, Z-axis, extruder, and mainboard.

**2. Base Construction & Material Selection**

- Tested base materials (wood, aluminum, thin steel, standard steel) and selected **standard steel** for maximum stability.
- Cut and fabricated the main base plate and the Z-axis base.
- Drilled precise holes to mount the Z-axis base to the main bed base.

**3. Custom Machining & Fabrication**

- Drilled mounting holes for the Z and X-axis linear rails.
- Machined custom steel mounts for the Y-axis (on linear rails), bed holder, and all stepper motors.
- Fabricated the main Z-axis frame and extruder mount.
- Cut routing holes for cables, mainboard ports, and base ventilation.

**4. Electronics Mounting**

- Securely mounted the Power Supply Unit (PSU) inside the base.
- Installed the mainboard into its designated housing.

**5. Core Assembly & Troubleshooting**

- Assembled the bed frame and attached the leveling springs.
- Assembled the X, Y, and Z axes, ensuring smooth travel on the linear rails (required adjusting the Z-axis to fix rotation binding and modifying the Y-axis to achieve full travel length).
- Mounted the extruder assembly to its custom bracket.

**6. Final Hardware & Wiring**

- Installed the front display and the BTT Eddy surface probe.
- Stripped wires and cleanly routed all cables to the mainboard.

**7. Finishing Touches**

- Painted the entire frame and custom components black for a clean, professional look.
- *(Note: Calibration and extrusion fine-tuning are currently in progress).*
